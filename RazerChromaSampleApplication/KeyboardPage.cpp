...
BEGIN_MESSAGE_MAP(CKeyboardPage, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_BUTTON_ALPHABET, &CKeyboardPage::OnBnClickedButtonAlphabet)
...
void CKeyboardPage::OnBnClickedButtonAlphabet()
{
	m_ChromaSDKImpl.ShowAlphabet(1, RGB(0, 255, 0));
}
